 ...
 */
class MidiDumperTest extends XmlTestCaseHelper
{
  ...
  public function testDumperXml()
  {
    ...
    $tests = array(
      ...
      # Meta attributes
      [ $this->tablature->getName()           #Not supported by MIDI
        , 'string(/song/name)'
        , 'Incorrect or missing Name element.'],
      [ $this->tablature->getArtist()         #Not supported by MIDI
        , 'string(/song/artist)'
        , 'Incorrect or missing Artist element.'],
      [ $this->tablature->getAlbum()          #Not supported by MIDI
        , 'string(/song/album)'
        , 'Incorrect or missing Album element.'],
      [ $this->tablature->getAuthor()         #Not supported by MIDI
        , 'string(/song/author)'
        , 'Incorrect or missing Author element.'],
      [ $this->tablature->getCopyright()      #Not supported by MIDI
        , 'string(/song/copyright)'
        , 'Incorrect or missing Copyright element.'],
      [ $this->tablature->getWriter()         #Not supported by MIDI
        , 'string(/song/writer)'
        , 'Incorrect or missing Writer element.'],
      [ $this->tablature->getComments()       #Not supported by MIDI
        , 'string(/song/comments)'
        , 'Incorrect or missing Comments element.'],
      [ $this->tablature->getDate()           #Not supported by MIDI
        , 'string(/song/date)'
        , 'Incorrect or missing Date element.'],
      [ $this->tablature->getTranscriber()    #Not supported by MIDI 
