 ...
 * Guitar Pro 5
 */
class GuitarPro5DumperTest extends XmlTestCaseHelper
{
  ...
  public function testDumperXml()
  {
    ...
    $tests = array(
      ...
      [ $this->tablature->getDate()           #Not supported by Guitar Pro 5
        , 'string(/song/date)'
        , 'Incorrect or missing Date element.'],
      [ $this->tablature->getTranscriber()    #Not supported by Guitar Pro 5  
      ...
      [ 0
        , 'count(/song/measureHeaders/header[72])'
